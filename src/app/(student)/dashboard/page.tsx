    ...
    <div className="space-y-8">
      ...
      <dl className="grid grid-cols-2 divide-border overflow-hidden rounded-card border border-border bg-surface lg:grid-cols-4 [&>*]:border-border max-lg:[&>*:nth-child(-n+2)]:border-b max-lg:[&>*:nth-child(odd)]:border-r lg:divide-x">
        <div className="px-5 py-4">
          <dt className="text-xs text-text-muted">Total projects</dt>
          <dd className="mt-1.5 text-2xl font-medium tracking-tight tabular-nums text-text-primary">{totalProjects}</dd>
        </div>
        <div className="px-5 py-4">
          <dt className="text-xs text-text-muted">Active</dt>
          <dd className="mt-1.5 text-2xl font-medium tracking-tight tabular-nums text-text-primary">{activeProjects}</dd>
        </div>
        <div className="px-5 py-4">
          <dt className="text-xs text-text-muted">Delivered</dt>
          <dd className="mt-1.5 text-2xl font-medium tracking-tight tabular-nums text-text-primary">{deliveredProjects}</dd>
        </div>
        <div className="px-5 py-4">
          <dt className="text-xs text-text-muted">Completed</dt>
          <dd className="mt-1.5 text-2xl font-medium tracking-tight tabular-nums text-text-primary">{completedProjects}</dd>
        </div>
      </dl>
